...
import com.example.fastfoodapp.userprofile.UserProfileViewModel;
    ...
    private EditUserProfileFragment findOrCreateFragment() {
        ...
        if (fragment == null) {
            ...
            ActivityUtils.addFragmentToActivity(getSupportFragmentManager(), fragment,
                    R.id.edit_profile_fragment_container, false);
        }
        return fragment;
    }
    ...
    private EditUserProfileViewModel findOrCreateViewModel() {
        ...
        if (holder != null) {
            ...
            ActivityUtils.addFragmentToActivity(getSupportFragmentManager(),
                    ViewModelHolder.createContainer(editUserProfileViewModel),
                    UserProfileViewModel.TAG, false);
